  ...
  <body <?php body_class();?>>
    <section id="masterhead">
      <section id="header-relative">
          ...
          <nav class="navbar navbar-inverse">
            <div class="container">
              <div class="col-md-4 col-sm-12 logotype">
                <div class="navbar-header">             <a class="navbar-brand" href="index-page.html"><img src="<?= TMPL_DIR ?>/assets/img/logo.png"/></a></div>
              </div>
        ...
        <div class="bottom-row-background"><img src="<?=TMPL_DIR ?>/assets/img/slide-1.jpg"/></div>
      </section>
    </section>